 ...
 */
public class d46_appendLastNToFirst {
	...
	public static Node<Integer> appendLastNNodesToFirst(Node<Integer> head, int n){		
		if(n==0 || head == null) {
			return head;
		}
	    ...
	    // If n is greater than or equal to the length, return the original list
	    if (n >= length) {
	        return head;
	    }
	...
	public static void main(String[] args) {
		...
		printLL(head);
		int n = sc.nextInt();
		head = appendLastNNodesToFirst(head, n);
		printLL(head);
	}
